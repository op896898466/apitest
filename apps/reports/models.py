...
class Reports(BaseModel):
    ...
    name = models.CharField('报告名称', max_length=255, unique=True, help_text='报告名称')
    ...
    html = models.CharField('报告HTML源码', max_length=400,help_text='报告HTML源码', null=True, blank=True, default='')
