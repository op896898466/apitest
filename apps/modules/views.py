...
from .serializers import ModulesSerializer, ModuleRunSerializer
from .utils import get_count_by_module
...
class ModulesViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        response.data['results'] = get_count_by_module(response.data['results'])
    ...
    def testcases(self, request, pk=None):
        ...
        """
        testcase_objs = Testcases.objects.filter(module_id=pk)
        one_list = []
    ...
    def configures(self, request, pk=None):
        ...
        Returns a list of all the testcases names by module id
        """
        configures_objs = Configures.objects.filter(module_id=pk)
        one_list = []
    ...
    def run(self, request, pk=None):
        ...
        testcase_objs = Testcases.objects.filter(module=instance)
    ...
    def get_serializer_class(self):
        ...
        :return:
        """
        return ModuleRunSerializer if self.action == 'run' else self.serializer_class
