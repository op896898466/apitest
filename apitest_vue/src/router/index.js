    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/builtin_add',
                    component: resolve => require(['../components/page/BuiltinAdd.vue'], resolve),
                    meta: { title: '函数新增' },
                    name: 'builtin_add'
                },
                {
                ...
                {
                    path: '/modules_list',
                    component: resolve => require(['../components/page/ModuleList.vue'], resolve),
                    meta: { title: '接口列表' },
                    name: 'modules_list'
                },
                {
                    path: '/modules_add',
                    component: resolve => require(['../components/page/ModuleAdd.vue'], resolve),
                    meta: { title: '接口新增' },
                    name: 'modules_add'
                },
                {
                ...
                {
                    path: '/locusts_list',
                    component: resolve => require(['../components/page/LocustList.vue'], resolve),
                    meta: { title: '性能测试列表' },
                    name: 'locusts_list'
                },
                {
                    path: '/locusts_add',
                    component: resolve => require(['../components/page/LocustAdd.vue'], resolve),
                    meta: { title: '新增性能测试 ' },
                    name: 'locusts_add'
                },
                {
                    path: '/locusts_edit/:id',
                    component: resolve => require(['../components/page/LocustEdit.vue'], resolve),
                    meta: { title: '编辑性能测试' },
                    name: 'locusts_edit'
                },
                {
                    path: '/locust_view',
                    component: resolve => require(['../components/page/LocustView.vue'], resolve),
                    meta: { title: '性能测试详情页' },
                    name: 'locust_view',

                },
                {
                    path: '/interfacemocks_list',
                    component: resolve => require(['../components/page/InterfacemockList.vue'], resolve),
                    meta: { title: 'Mock列表' },
                    name: 'interfacemocks_list',

                },
                {
                    path: '/interfacemocks/:id',
                    component: resolve => require(['../components/page/MockList.vue'], resolve),
                    meta: { title: 'Mock详情' },
                    name: 'interfacemocks',
...
router.beforeEach((to, from, next) => {
    ...
    if (!token && to.path !== '/login' && to.path !== '/register') {   // 如果没有token值, 那么重定向到登录页面
        ...
        let routerName = ['builtin_edit', 'configures_edit', 'testcases_edit', 'reports_view', 'testsuites_edit', 'locusts_edit', "interfacemocks"];
