        ...
        <div class="container">
            <div class="handle-box">
                <el-button
                    ...
                    @click="delAll"
                >批量删除</el-button>
                <router-link to="configures_add">
                    <el-button type="primary" icon="el-icon-plus" class="handle-del mr10">新增配置</el-button>
                </router-link>
            ...
            >
                ...
                <el-table-column prop="author" label="编辑人员" width="100" align="center"></el-table-column>
    ...
    computed: {
        data() {
            return this.tableData.filter((d) => {
                ...
                if (!is_del) {
                    if (d.name.indexOf(this.select_word) > -1 || d.author.indexOf(this.select_word) > -1) {
                        return d;
                    }
                }
            });
    ...
    methods: {
        ...
        delAll() {
            ...
            for (let i = 0; i < length; i++) {
                ...
                delete_configure(this.multipleSelection[i].id)
                    .then((response) => {})
                    .catch((error) => {
