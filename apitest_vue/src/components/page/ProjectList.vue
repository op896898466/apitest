    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <router-link to="projects_add">
                    <el-button type="primary" icon="el-icon-plus" class="handle-del mr10">新增项目</el-button>
                </router-link>
            ...
            >
                ...
                <el-table-column prop="name" label="项目名称" width="250">
                    <template slot-scope="scope">
                        <el-popover trigger="hover" placement="top">
                            ...
                            <p>模块数: {{ scope.row.modules }}</p>
                            <p>用例数: {{ scope.row.testcases }}</p>
                            <p>套件数: {{ scope.row.testsuites }}</p>
                ...
                <el-table-column prop="publish_app" label="应用名称" width="250"></el-table-column>
        ...
        <el-dialog title="编辑项目" :visible.sync="editVisible" width="30%" center>
            <el-form ref="form" :model="form" label-width="120px">
                ...
                <el-form-item label="应用名称" prop="publish_app" required>
                    <el-input v-model="form.publish_app" clearable></el-input>
                </el-form-item>
                <el-form-item label="内置函数" prop="debugtalk_id">
                    <el-select v-model="form.debugtalk_id" clearable placeholder="请选择" width="150%">
                        <el-option
        ...
        <el-dialog title="批量删除项目" :visible.sync="delAllVisible" width="300px" center>
            <div class="del-dialog-cnt">删除不可恢复，是否确定删除？</div>
            <span slot="footer" class="dialog-footer">
...
<script>
import { projects_list, delete_project, edit_project, envs_names, run_by_project, builtins_names } from '../../api/api';
    ...
    methods: {
        ...
        confirmRun() {
            if (this.env_id) {
                ...
                run_by_project(this.project_id, { env_id: this.env_id })
                    .then((response) => {
        ...
        confirmRunAsyn() {
            if (this.env_id) {
                ...
                run_by_project(this.project_id, datas).catch((error) => {
                    if (typeof error === 'object' && error.hasOwnProperty('msg')) {
