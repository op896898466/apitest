    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <router-link to="testsuites_add">
                    <el-button type="primary" icon="el-icon-plus" class="handle-del mr10">新增套件</el-button>
                </router-link>
            ...
            >
                ...
                <!-- <el-table-column type="expand" label="更多">
                    <template slot-scope="props">
                        <p v-for="(item,key) in props.row.include" :key="key">
                            <a href="">{{ item.name }}</a>
                        </p>
                    </template>
                </el-table-column>-->
                ...
                <el-table-column prop="name" label="套件名称" width="250"></el-table-column>

                <el-table-column prop="project" label="所属项目" sortable align="center"></el-table-column>

                <el-table-column prop="include" label="包含模块数" sortable align="center"></el-table-column>
        ...
        <el-dialog title="批量删除套件" :visible.sync="delAllVisible" width="300px" center>
            <div class="del-dialog-cnt">删除不可恢复，是否确定删除？</div>
            <span slot="footer" class="dialog-footer">
    ...
    methods: {
        ...
        confirmRun() {
            if (this.env_id) {
                ...
                run_by_testsuite(this.id, { env_id: this.env_id })
                    .then((response) => {
        ...
        confirmRunAsyn() {
            if (this.env_id) {
                ...
                run_by_testsuite(this.id, datas).catch((error) => {
                    if (typeof error === 'object' && error.hasOwnProperty('msg')) {
