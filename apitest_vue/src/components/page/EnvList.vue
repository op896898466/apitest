    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-calendar"></i> 环境管理
                </el-breadcrumb-item>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <router-link to="envs_add">
                    <el-button type="primary" icon="el-icon-plus" class="handle-del mr10">新增环境</el-button>
                </router-link>
            ...
            >
                ...
                <el-table-column prop="name" label="环境名称" width="200"></el-table-column>

                <el-table-column prop="base_url" label="base_url" width="350" align="center"></el-table-column>
        ...
        <el-dialog title="批量删除环境" :visible.sync="delAllVisible" width="300px" center>
            <div class="del-dialog-cnt">删除不可恢复，是否确定删除？</div>
            <span slot="footer" class="dialog-footer">
