    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="el-icon-delete" class="handle-del mr10" @click="delAllVisible = true">批量删除</el-button>
        ...
        <!-- 删除提示框 -->
        <el-dialog title="删除报告" :visible.sync="delVisible" width="300px" center>
        ...
        <el-dialog title="批量删除报告" :visible.sync="delAllVisible" width="300px" center>
            <div class="del-dialog-cnt">删除不可恢复，是否确定删除？</div>
            <span slot="footer" class="dialog-footer">
