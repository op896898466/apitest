            ...
            saveEdit() {
                ...
                if (this.apiMsgData.choiceType === 'files') {
                    ...
                    for (let i = 0; i < len; i++){
                        ...
                        console.log(this.apiMsgData.filesVariable[i])
            ...
            getTestcaseDetail(){
                get_detail_testcase(this.current_testcase_id)
                    .then(response => {
                        ...
                        this.apiMsgData.filesVariable = response.data.files;
                        if ( this.apiMsgData.jsonVariable != 'null') {             
                            this.apiMsgData.choiceType = 'json';                           
                        }else if(this.apiMsgData.filesVariable.length){
                            this.apiMsgData.choiceType = "files"
                        }else{
